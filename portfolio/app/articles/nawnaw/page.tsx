...
export const metadata: Metadata = {
  title: "Designing a 15-minute grocery run · Haye",
  description:
    "The written version of NawNaw: a dark-store model for Nigerian tier-1 cities, the unit economics behind a fifteen-minute promise, and why the hard part was never the app.",
};

export default function NawNawArticlePage() {
  return (
    <div style={{ background: "var(--color-ink)" }}>
      <CaseStudyHero
        ...
        lede={
          <>
            It isn&apos;t really an app about essentials. It&apos;s an app about{" "}
            <em className="italic text-[var(--color-accent)]">time</em>, and about handing a
            little of it back.
          </>
        }
        meta={[
          ...
          { label: "See it working", value: "/work/nawnaw" },
        ]}
      />
      ...
      <Section>
        <div className="flex flex-col gap-12">
          ...
          <div className="flex flex-col gap-4 reveal">
            ...
            <div className="my-8 flex flex-col gap-3">
              <LightboxImage 
                src="/assets/nawnaw/Profile-HSI.webp" 
          ...
          <div className="flex flex-col gap-4 reveal">
            ...
            <div className="my-8 flex flex-col gap-3">
              <LightboxImage 
                src="/assets/nawnaw/Cart states.webp" 
                alt="Cart States"
                className="max-w-full max-h-[85vh] w-auto object-contain"
              />
              <ImageCallouts
          ...
          <div className="flex flex-col gap-4 reveal">
            ...
            <div className="my-8 flex flex-col gap-3">
              <LightboxImage 
                src="/assets/nawnaw/Guest-flow.webp" 
          ...
          <div className="flex flex-col gap-4 reveal">
            ...
            <div className="my-8 flex flex-col gap-3">
              <LightboxImage 
                src="/assets/nawnaw/Address confirmation.webp" 
          ...
          <div className="flex flex-col gap-4 reveal">
            ...
            <div className="my-8 flex flex-col gap-3">
              <LightboxImage 
                src="/assets/nawnaw/Order tracking.webp" 
                alt="Order Tracking"
                className="max-w-full max-h-[85vh] w-auto object-contain"
              />
              <ImageCallouts
          ...
          <div className="flex flex-col gap-4 reveal">
            ...
            <div className="my-8 flex flex-col gap-3">
              <LightboxImage 
                src="/assets/nawnaw/Product details page.webp" 
      ...
      <CaseStudyFooter
        ...
        nextLabel="See the screens"
        stat="Written version · full concept"
        colophonLeft="NawNaw: the written case study"
      />
    </div>
  );
}
